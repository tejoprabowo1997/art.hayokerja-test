    ...
    >
      ...
      >
        ...
        >
          Temukan
          <span
            class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl 2xl:text-5xl font-extrabold text-primary"
          >
            A</span
          >sisten
          <span
          ...
          <span
            class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl 2xl:text-5xl font-extrabold text-primary"
            >T</span
          >angga Terpercaya untuk Membantu Kebutuhan Anda!
        </div>
      </div>
      <LazyNuxtImg
        src="/housekeeping-interview.jpeg"
